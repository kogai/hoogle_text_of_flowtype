...
and translate_statement ~root ~comments = Statement.(function
    | _, DeclareFunction ({
    ...
    | _, ImportDeclaration _ -> NoDeclare
    | _, _ -> Utils.unreachable ~message:"Hit unhandled match";
  )
